...
@section('main-content')
    <div class="row">
        <div class="col-md-12 mb-4">
            <a href="/admin/posts" class="gobacklist"><i class="fa fa-arrow-left" aria-hidden="true"></i>&nbsp; Danh sách bài viết</a>
        </div>
        <div class="col-md-12">
                        ...
                        <form class="form row" action="#" method="post" id="accountForm">
                            ...
                            <div class="form-group col-md-12 position-relative">
                                ...
                                <div class="w-100" data-emojiarea="" data-type="unicode" data-global-picker="true">
                                    <i class="emoji emoji-smile emoji-button fa fa-smile-o text-secondary position-absolute" id="emoji_new_posts" aria-hidden="true" style="top: 30px; right: 10px;z-index: 1;"></i>
...
{{--                                <textarea type="text" class="form-control" id="title_posts" placeholder="Nhập tiêu đề" style="resize: vertical;"></textarea>--}}
                            </div>
                            <div class="form-group">
                                <div class="col-md-12">
                                    <button class="btn btn-sm btn-success" type="submit"><i class="fa fa-save"></i>&nbsp; Lưu</button>
                                    <button id="refresh_form" class="btn btn-sm btn-secondary" type="button"><i class="fa fa-refresh"></i>&nbsp; Làm mới</button>
                                </div>
                            </div>
                        </form>
                    </div>
