        ...
        <div class="row row-header" style="box-shadow: 0 1px 5px -2px #888;">
            ...
            <div class="col-md-5">
                <ul class="menu-header ml-5 clearfix">
                    ...
                    <li class="item-menu float-left mr-4"><a href="/shops/list" title="Cửa hàng"><i class="fa fa-archive"></i></a></li>
                            ...
                            <div class="float-left" style="padding-top: 8px;">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    @if(\Illuminate\Support\Facades\Auth::user()->shop)
                                        <a href="#" id="btn-channel-shop" class="dropdown-item"><i class="fa fa-font-awesome" aria-hidden="true"></i>&nbsp; Kênh bán hàng</a>
                                    @else
